...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/system/system/android.software.device_id_attestation.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/system/android.software.device_id_attestation.xml \
